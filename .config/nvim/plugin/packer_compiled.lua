...
_G.packer_plugins = {
  ["better-escape.nvim"] = {
    loaded = true,
    path = "/Users/Matt/.local/share/nvim/site/pack/packer/start/better-escape.nvim",
  ...
  ["galaxyline.nvim"] = {
    loaded = true,
    path = "/Users/Matt/.local/share/nvim/site/pack/packer/start/galaxyline.nvim",
  ...
  ["gruvbox-material"] = {
    loaded = true,
    path = "/Users/Matt/.local/share/nvim/site/pack/packer/start/gruvbox-material",
  ...
  playground = {
    loaded = true,
    path = "/Users/Matt/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["rust.vim"] = {
    loaded = true,
    path = "/Users/Matt/.local/share/nvim/site/pack/packer/start/rust.vim",
